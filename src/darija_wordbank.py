...
DARIJA_GREETINGS = {
    "كيداير",
    "كيدايرة",
    "كيدايرين",  # Comment ça va (m/f/pl)
    "لاباس",
    "لا باس",  # Ça va / pas mal
    "بخير",
    "مزيان",
    "مزيانة",  # Bien
    "حمدلله",
    ...
    "بسلامة",
    "تبارك الله",  # Au revoir / Mashallah
    "صباح الخير",
    "مساء الخير",  # Bonjour / Bonsoir
    "تحياتي",  # Salutations
    "سلام",
    "السلام",  # Salut
    "أهلا",
...
DARIJA_VERBS = {
    ...
    "ولا",
    "وليت",
    "ولاو",  # Devenir/Retourner
    "بان",
    "بانت",
    "بانو",
    "بان ليا",  # Apparaître/Sembler
    "حط",
    "حطيت",
    "حطو",  # Poser/Mettre
    "طيب",
...
DARIJA_EXPRESSIONS = {
    ...
    "أنا معاك",
    "راه",  # Je suis avec toi / C'est que
    "هاهو",
    "هاهي",
    "هاهم",  # Le/La/Les voilà
    "عاد",
    "باقي",
    "مازال",  # Encore
    "خلاص",
...
DARIJA_LATIN_NUMBER_PATTERN = re.compile(
    r"\b\w*[3279]\w*\b", re.IGNORECASE  # Mots contenant 3, 2, 7, 9 (sons arabes)
)
